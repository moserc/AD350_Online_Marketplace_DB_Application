...
public class acmeAppPrototypeDriver {
    ...
    private static String case7_2(String startDate, String endDate) {
        StringBuilder temp = new StringBuilder();
    ...
    private static String case7_3(int userID) {
        StringBuilder temp = new StringBuilder();
